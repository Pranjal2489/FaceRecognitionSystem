...
# Department
        ...
        dep_combo=ttk.Combobox(current_course_frame,font=("times new roman",11,"bold"),width=20,state="readonly")
        ...
        course_combo=ttk.Combobox(current_course_frame,font=("times new roman",11,"bold"),state="readonly",width=20)
        ...
        year_combo=ttk.Combobox(current_course_frame,font=("times new roman",11,"bold"),state="readonly",width=20)
        ...
        semester_combo=ttk.Combobox(current_course_frame,font=("times new roman",11,"bold"),state="readonly",width=20)
        ...
        studentID_entry=ttk.Entry(class_student_frame,width=20,font=("times new roman",11,"bold"))
        ...
        studentName_entry=ttk.Entry(class_student_frame,width=20,font=("times new roman",11,"bold"))
        ...
        class_div_entry=ttk.Entry(class_student_frame,width=20,font=("times new roman",11,"bold"))
        ...
        roll_no_entry=ttk.Entry(class_student_frame,width=20,font=("times new roman",11,"bold"))
        ...
        Gender_entry=ttk.Entry(class_student_frame,width=20,font=("times new roman",11,"bold"))
        ...
        dob_entry=ttk.Entry(class_student_frame,width=20,font=("times new roman",11,"bold"))
        ...
        email_entry=ttk.Entry(class_student_frame,width=20,font=("times new roman",11,"bold"))
        ...
        phone_no_entry=ttk.Entry(class_student_frame,width=20,font=("times new roman",11,"bold"))
        ...
        address_entry=ttk.Entry(class_student_frame,width=20,font=("times new roman",11,"bold"))
        ...
        teacher_entry=ttk.Entry(class_student_frame,width=20,font=("times new roman",11,"bold"))
        ...
        radionbtn2.grid(row=5, column=1, padx=10, pady=5)
        ...
        save_btn=Button(btn_frame,text="Save",width=21,font=("times new roman",10,"bold"),bg="blue",fg="white")
        save_btn.grid(row=0,column=0)

        update_btn=Button(btn_frame,text="Update",width=21,font=("times new roman",10,"bold"),bg="blue",fg="white")
        update_btn.grid(row=0,column=1)

        delete_btn=Button(btn_frame,text="Delete",width=21,font=("times new roman",10,"bold"),bg="blue",fg="white")
        ...
        take_photo_btn=Button(btn_frame1,text="Take Photo Sample",width=44,font=("times new roman",10,"bold"),bg="blue",fg="white")
